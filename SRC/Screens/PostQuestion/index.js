...
import {OnlineNotification, getExperties, postNewQuestion} from '../../Api';
        ...
        <ScrollView style={{flex: 1}}>
          <View style={Styles.innercontainer}>
            ...
            <View style={Styles.Videoview}>
              <View style={Styles.recodmenuview}>
                ...
                <Text style={Styles.text}>
                  {typequestion != '' ? typequestion : 'Add Yor Question'}
                </Text>
            ...
            <TextInput
              ...
              onChangeText={txt => settypequestion(txt)}></TextInput>
            <View style={Styles.hedview}>
            ...
            <View style={Styles.buttonview}>
              <RButton
                ...
                title={
                  <View
                    style={[Styles.liveview, {width: wp(40), height: wp(12)}]}>
                    <Image
                      source={require('../../Assests/liv.png')}
                      resizeMode="contain"
                      style={[Styles.imaginner1, {width: wp(6), height: wp(6)}]}
                    />
        ...
        <View style={Styles.centeredView}>
          <View style={Styles.confmodal}>
            <Text style={Styles.temodal}>
              Whoule you prefer quick response?
            </Text>
